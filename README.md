# Skillfactory.-Zadanie-18.6.1.-sozdanie-bota-telegram

Написать и протестировать Telegram-бота ( его название @CryptoTutorial2000Bot в телеграмме), в котором будет реализован следующий функционал:
